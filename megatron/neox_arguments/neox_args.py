...
class NeoXArgsTokenizer(NeoXArgsTemplate):
    ...
    """
    Type of tokenizer to use - should be one of ["GPT2BPETokenizer", "HFTokenizer", "HFGPT2Tokenizer", "SPMTokenizer", "CharLevelTokenizer", "TiktokenTokenizer", "LlamaTokenizer"]
    """
...
class NeoXArgsTraining(NeoXArgsTemplate):
    ...
    initialize_llama_cn_with_llama_word_embeddings: bool = False
    """
    A specific function for initializing the llama_cn model with the llama word embeddings. Should set "load" field to a llama model while using llama-cn tokenizer.
    """
    
    only_train_new_chinese: bool = False
    """
