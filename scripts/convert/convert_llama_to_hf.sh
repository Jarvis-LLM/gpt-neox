...
### output log
#SBATCH --output=sbatch_convert_yulan_stage0.log
...
model_id="yulan_stage_0"
step="global_step4800"
input_dir=/fs/fast/share/jarvis/checkpoints/13B/$model_id/$step
config_file=/home/share/gsai_joint_project/llama_train/gpt-neox-main/jarvis_configs/13B/$model_id/hf_config.yml
