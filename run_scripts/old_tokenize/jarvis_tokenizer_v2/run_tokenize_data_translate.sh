...
#SBATCH --job-name="tokenize_jarvis_v2_translate"
...
#SBATCH --output="tokenize_jarvis_v2_translate.log"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/translate/train \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/translate/en-zh/translate-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/translate/val \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
