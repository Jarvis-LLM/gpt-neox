...
#SBATCH --job-name="tokenize_jarvis_v2_philpapers"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_philpapers.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/jarvis_v2/philpapers/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/PhilPapers.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/philpapers/train \
...
#             --output-prefix /fs/fast/u2021000178/data/new_jarvis_v2_tokenized/csl/val \
