...
#SBATCH --job-name="tokenize_jarvis_v2_cicg_v2_p2"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_v2/cicg-v2-p2-train.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/cicg_v2_p2/train \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_v2/cicg-v2-p2-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/cicg_v2_p2/val \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
