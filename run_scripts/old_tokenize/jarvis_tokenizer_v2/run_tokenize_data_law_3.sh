...
#SBATCH --job-name="tokenize_jarvis_v2_law_3"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/law/cleaned/law-train.3.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/law_cleaned/train_3 \
