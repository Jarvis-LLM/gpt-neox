...
#SBATCH --job-name="tokenize_jarvis_v2_openwebtext2"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_openwebtext2.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/jarvis_v2/openwebtext2/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/data_v1/OpenWebText2.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/openwebtext2/train \
