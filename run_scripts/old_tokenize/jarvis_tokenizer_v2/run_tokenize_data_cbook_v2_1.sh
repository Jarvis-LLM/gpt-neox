...
#SBATCH --job-name="tokenize_jarvis_v2_cbook_v2_1"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cbook_v2/cbook_v2-train.1.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/cbook_v2/train_1 \
