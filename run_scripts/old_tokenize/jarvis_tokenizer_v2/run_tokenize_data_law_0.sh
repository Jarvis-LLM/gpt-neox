...
#SBATCH --job-name="tokenize_jarvis_v2_law_0"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/law/cleaned/law-train.0.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/law_cleaned/train_0 \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/law/cleaned/law-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/law_cleaned/val \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
