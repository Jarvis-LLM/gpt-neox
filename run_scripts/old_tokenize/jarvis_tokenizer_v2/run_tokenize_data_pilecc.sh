...
#SBATCH --job-name="tokenize_jarvis_v2_pilecc"
...
mkdir /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilecc/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilecc/train \
