...
#SBATCH --job-name="tokenize_jarvis_v2_pilevt_github"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_jarvis_v2_pilevt_github.log
...
dirpath=/fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/github
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/val/Github.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/github/val \
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/test/Github.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/github/test \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
