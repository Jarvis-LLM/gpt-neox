...
#SBATCH --job-name="tokenize_jarvis_v2_pilevt_pilecc"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_jarvis_v2_pilevt_pilecc.log
...
dirpath=/fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/pilecc
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/val/Pile-CC.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/pilecc/val \
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/test/Pile-CC.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/pilecc/test \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
