...
#SBATCH --job-name="tokenize_jarvis_v2_pilevt_wiki_en"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_jarvis_v2_pilevt_wiki_en.log
...
dirpath=/fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/wiki_en
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/val/Wikipedia\ \(en\).jsonl  \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/wiki_en/val \
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/test/Wikipedia\ \(en\).jsonl  \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pilevt/wiki_en/test \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
