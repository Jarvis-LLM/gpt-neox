...
#SBATCH --job-name="tokenize_jarvis_v2_freelaw"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/FreeLaw.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/freelaw/train \
