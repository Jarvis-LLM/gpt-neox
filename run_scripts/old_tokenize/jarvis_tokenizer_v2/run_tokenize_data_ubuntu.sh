...
#SBATCH --job-name="tokenize_jarvis_v2_ubuntu"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_ubuntu.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/jarvis_v2/ubuntu/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/Ubuntu_IRC.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/ubuntu/train \
