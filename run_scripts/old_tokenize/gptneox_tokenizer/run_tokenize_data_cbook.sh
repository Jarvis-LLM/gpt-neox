...
#SBATCH --job-name="tokenize_gptneox_cbook"
...
#SBATCH --output=tokenize_gptneox_cbook.log
### 以上参数用来申请所需资源
### 以下命令将在计算节点执行
...
mkdir /fs/fast/share/jarvis/tokenized_data/gptneox/cbook/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/gptneox/cbook/train \
            --vocab /fs/fast/share/jarvis/tokenizer/gptneox/tokenizer.json \
            --dataset-impl mmap \
