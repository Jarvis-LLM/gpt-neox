...
#SBATCH --job-name="tokenize_yulan_v1_mmlu_auxiliary_train_v1"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_yulan_v1_mmlu_auxiliary_train_v1.log
...
output_dir=$base_tokenized_dir/$tokenizer_name/$dataset
mkdir $output_dir
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input $base_data_dir/$dataset/$dataset_version/$part.jsonl \
            --output-prefix $output_dir/train_$part \
