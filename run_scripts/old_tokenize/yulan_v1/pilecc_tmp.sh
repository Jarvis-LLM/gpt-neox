...
#SBATCH --job-name="tokenize_yulan_v1_pilecc_tmp"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_yulan_v1_pilecc_tmp.log
...
mkdir $base_tokenized_dir/$tokenizer_name
output_dir=$base_tokenized_dir/$tokenizer_name/pilecc_tmp
mkdir $output_dir



python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input $base_data_dir/$dataset/$dataset_version/pilecc-train.0.jsonl \
            --output-prefix $output_dir/train_0 \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input $base_data_dir/$dataset/$dataset_version/pilecc-train.1.jsonl \
            --output-prefix $output_dir/train_1 \
            --vocab $tokenizer_path \
            --dataset-impl mmap \
            --tokenizer-type $tokenizer_type \
            --append-eod \
