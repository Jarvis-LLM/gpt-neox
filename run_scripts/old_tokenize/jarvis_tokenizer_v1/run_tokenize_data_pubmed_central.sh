...
#SBATCH --job-name="tokenize_jarvis_v1_pubmed_central"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/PubMed_Central.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v1/pubmed_central/train \
...
#             --output-prefix /fs/fast/u2021000178/data/new_jarvis_v1_tokenized/csl/val \
