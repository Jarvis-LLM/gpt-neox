...
#SBATCH --job-name="tokenize_llama_wiki_en"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_wiki_en.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/wiki_en/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/wiki_en/train \
