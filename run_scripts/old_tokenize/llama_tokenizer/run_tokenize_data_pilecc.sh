...
#SBATCH --job-name="tokenize_llama_pilecc"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_pilecc.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/pilecc/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/Pile-CC.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/pilecc/train \
