...
#SBATCH --job-name="tokenize_llama_cicg_en_0"
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/cicg_en/

python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_en/cicg_en-train.0.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cicg_en/train_0 \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_en/cicg_en-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cicg_en/val \
            --vocab /home/share/gsai_joint_project/llama_train/gpt-neox-main/run_scripts/tokenize/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
