...
#SBATCH --job-name="tokenize_llama_cicg_cn"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_cicg_cn.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/cicg_cn/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_v2/cicg-v2-p1-train.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cicg_cn/train_0 \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_v2/cicg-v2-p1-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cicg_cn/val \
            --vocab /home/share/gsai_joint_project/llama_train/gpt-neox-main/run_scripts/tokenize/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
