...
#SBATCH --job-name="tokenize_llama_arxiv"
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/arxiv/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/arxiv/arxiv-train.0.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/arxiv/train_0 \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/arxiv/arxiv-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/arxiv/val \
            --vocab /home/share/gsai_joint_project/llama_train/gpt-neox-main/run_scripts/tokenize/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
