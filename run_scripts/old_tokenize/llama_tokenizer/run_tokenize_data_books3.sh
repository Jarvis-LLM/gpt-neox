...
#SBATCH --job-name="tokenize_llama_books3"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_books3.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/books3/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/data_v1/Gutenberg+Books3/Books3.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/books3/train \
