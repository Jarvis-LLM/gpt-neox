...
#SBATCH --job-name="tokenize_llama_cicg_en_3"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_en/cicg_en-train.3.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cicg_en/train_3 \
