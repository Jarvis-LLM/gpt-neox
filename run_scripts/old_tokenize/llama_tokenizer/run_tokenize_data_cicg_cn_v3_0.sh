...
#SBATCH --job-name="tokenize_llama_cicg_cn_v3_0"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_cicg_cn_v3.0.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/cicg_cn_v3/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cicg_cn_v3/train_0 \
