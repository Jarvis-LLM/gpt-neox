...
#SBATCH --job-name="tokenize_llama_wiki_with_title"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_wiki_with_title.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/wiki_with_title/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/u2021000178/data/wiki_with_title/wiki_with_title.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/wiki_with_title/train \
