...
#SBATCH --job-name="tokenize_llama_cbook"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_cbook.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/cbook/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cbook_v2/cbook_v2-train.0.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cbook/train \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cbook_v2/cbook_v2-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/cbook/val \
            --vocab /home/share/gsai_joint_project/llama_train/gpt-neox-main/run_scripts/tokenize/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
