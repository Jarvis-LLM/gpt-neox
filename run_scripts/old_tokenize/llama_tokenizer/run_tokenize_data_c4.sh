...
#SBATCH --job-name="tokenize_llama_c4"
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/c4/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/c4/train_0 \
