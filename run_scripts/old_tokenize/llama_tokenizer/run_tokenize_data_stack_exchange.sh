...
#SBATCH --job-name="tokenize_llama_stackexchange"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_stack_exchange.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/stack_exchange/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/stack_exchange/train \
