...
#SBATCH --job-name="tokenize_llama_law"
...
### 指定该作业的输出文件
#SBATCH --output=tokenize_law.log
...
mkdir /fs/fast/share/jarvis/tokenized_data/llama/law/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input  /fs/fast/share/jarvis/law/law-train.0.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/law/train \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/law/law-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/llama/law/val \
            --vocab /home/share/gsai_joint_project/llama_train/gpt-neox-main/run_scripts/tokenize/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
