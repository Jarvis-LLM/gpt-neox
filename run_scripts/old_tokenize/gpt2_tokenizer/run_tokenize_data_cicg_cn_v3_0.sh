...
#SBATCH --job-name="tokenize_gpt2_cicg_cn_v3.0"
...
#SBATCH --output=tokenize_gpt2_cicg_cn_v3.0.log
### 以上参数用来申请所需资源
### 以下命令将在计算节点执行
...
mkdir /fs/fast/share/jarvis/tokenized_data/gpt2/cicg_cn_v3/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg_cn_v3/cicg_cn_v3-train.0.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/gpt2/cicg_cn_v3/train \
