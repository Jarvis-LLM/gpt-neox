...
#SBATCH --job-name="tokenize_gpt2_stack-exchange"
...
#SBATCH --output=tokenize_gpt2_stack_exchange.log
### 以上参数用来申请所需资源
### 以下命令将在计算节点执行
...
mkdir /fs/fast/share/jarvis/tokenized_data/gpt2/stack_exchange/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
             --input /fs/archive/share/jarvis/pile_original/data_v1/StackExchange.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/gpt2/stack_exchange/train_0 \
            --vocab /fs/fast/share/jarvis/tokenizer/gpt2/gpt2-vocab.json \
            --merge-file /fs/fast/share/jarvis/tokenizer/gpt2/gpt2-merges.txt \
            --dataset-impl mmap \
