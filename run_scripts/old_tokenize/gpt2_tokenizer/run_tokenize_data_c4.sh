...
#SBATCH --job-name="tokenize_gpt2_c4_0"
...
#SBATCH --output=tokenize_gpt2_c4_0.log
### 以上参数用来申请所需资源
### 以下命令将在计算节点执行
...
mkdir /fs/fast/share/jarvis/tokenized_data/gpt2/c4/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/u2021000178/data/c4/c4.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/gpt2/c4/train_0 \
