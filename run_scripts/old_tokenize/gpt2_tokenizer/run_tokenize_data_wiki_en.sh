...
#SBATCH --job-name="tokenize_gpt2_wiki_en"
...
#SBATCH --output=tokenize_gpt2_wiki_en.log
### 以上参数用来申请所需资源
### 以下命令将在计算节点执行
...
mkdir /fs/fast/share/jarvis/tokenized_data/gpt2/wiki_en/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/Wikipedia_\(en\).jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/gpt2/wiki_en/train_0 \
