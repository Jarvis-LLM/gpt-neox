...
#SBATCH --job-name="tokenize_gpt2_cbook_0"
...
#SBATCH --output=tokenize_gpt2_cbook.0.log
### 以上参数用来申请所需资源
### 以下命令将在计算节点执行
...
mkdir /fs/fast/share/jarvis/tokenized_data/gpt2/cbook/
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/share/jarvis/tokenized_data/gpt2/cbook/train_0 \
