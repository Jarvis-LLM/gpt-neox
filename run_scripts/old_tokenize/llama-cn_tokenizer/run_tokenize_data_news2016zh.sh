...
#SBATCH --job-name="tokenize_llama-cn_news2016zh"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/news2016zh/news2016zh-train.jsonl\
            --output-prefix /fs/fast/u2021000178/data/new_llama-cn_tokenized/news2016zh/train \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/news2016zh/news2016zh-val.jsonl\
            --output-prefix /fs/fast/u2021000178/data/new_llama-cn_tokenized/news2016zh/val \
            --vocab /home/share/jarvis/tokenizer/llama_chinese_tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
