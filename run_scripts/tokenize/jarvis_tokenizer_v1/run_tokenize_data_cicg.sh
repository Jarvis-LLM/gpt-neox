...
#SBATCH --job-name="tokenize_jarvis_v1_cicg"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg/cicg-train.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v1/cicg/train \
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/fast/share/jarvis/cicg/cicg-val.jsonl \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v1/cicg/val \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v1/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
