...
#SBATCH --job-name="tokenize_jarvis_v2_pile_val_test"
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile/test.jsonl.zst \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pile_val_test/test \
...
python tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile/val.jsonl.zst \
            --output-prefix /fs/fast/share/jarvis/tokenized_data/jarvis_v2/pile_val_test/val \
            --vocab /fs/fast/share/jarvis/tokenizer/jarvis_tokenizer_v2/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
