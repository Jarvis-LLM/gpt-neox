...
#SBATCH --job-name="tokenize_llama-cn_europarl"
...
python /home/share/gsai_joint_project/llama_train/gpt-neox-main/tools/preprocess_data.py \
            --input /fs/archive/share/jarvis/pile_original/EuroParl.jsonl \
            --output-prefix /fs/fast/u2021000178/data/new_llama-cn_tokenized/europarl/train \
