...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v19-continue_train_v15_with_translate.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v19-continue_train_v15_with_translate params.yml setup.yml -H 7B_v19_hostfile
