...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v14-new_data_source.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v14-new_data_source params.yml setup.yml -H 7B_v14_hostfile
