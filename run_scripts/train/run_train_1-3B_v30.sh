...
#SBATCH --job-name=train_1-3B_v30
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v30.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v30-en_20B_cn_10B params.yml setup.yml -H 1-3B_v30_hostfile

rm 1-3B_v30_hostfile