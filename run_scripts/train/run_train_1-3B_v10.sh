...
#SBATCH --job-name=train_1-3B_v10
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v10.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v10-yulan_tokenizer params.yml setup.yml -H 1-3B_v10_hostfile

rm 1-3B_v10_hostfile