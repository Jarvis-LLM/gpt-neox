...
#SBATCH --job-name=train_1-3B_v36
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v36.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v36-en_20B_cn_cicg_10B params.yml setup.yml -H 1-3B_v36_hostfile

rm 1-3B_v36_hostfile