...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v15-learn_chinese.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v15-learn_chinese params.yml setup.yml -H 7B_v15_hostfile
