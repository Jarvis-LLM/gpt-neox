...
#SBATCH --job-name=train_1-3B_v25
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v25.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v25-en_25B_hq_25B_based_on_v11 params.yml setup.yml -H 1-3B_v25_hostfile

rm 1-3B_v25_hostfile