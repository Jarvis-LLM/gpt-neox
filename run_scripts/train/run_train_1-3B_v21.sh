...
#SBATCH --job-name=train_1-3B_v21
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v21.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v21-plus_cn_book_on_v11 params.yml setup.yml -H 1-3B_v21_hostfile

rm 1-3B_v21_hostfile