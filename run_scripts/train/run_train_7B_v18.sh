...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v18-all_translate.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v18-all_translate params.yml setup.yml -H 7B_v18_hostfile
