...
#SBATCH --job-name=train_1-3B_v31
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v31.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v31-en_13B_cn_p1_7B params.yml setup.yml -H 1-3B_v31_hostfile

rm 1-3B_v31_hostfile