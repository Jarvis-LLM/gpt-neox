...
#SBATCH --job-name=train_1-3B_v43
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v43.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v43-en_20B_cn_hq_10B_real params.yml setup.yml -H 1-3B_v43_hostfile

rm 1-3B_v43_hostfile