...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v17-continue_train_en_with_smaller_lr.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v17-continue_train_en_with_smaller_lr params.yml setup.yml -H 7B_v17_hostfile
