...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v8.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v8-gpt2_tokenizer params.yml setup.yml -H 1-3B_v8_hostfile
