...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v12-continue_train_en.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v12-continue_train_en params.yml setup.yml -H 7B_v12_hostfile
