...
#SBATCH --job-name=train_1-3B_v17
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v17.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v17-1_16_cn_en params.yml setup.yml -H 1-3B_v17_hostfile

rm 1-3B_v17_hostfile