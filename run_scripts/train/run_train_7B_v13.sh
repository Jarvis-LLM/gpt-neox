...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v13-expand_ctx_len.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v13-expand_ctx_len params.yml setup.yml -H 7B_v13_hostfile
