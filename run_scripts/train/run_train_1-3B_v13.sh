...
#SBATCH --job-name=train_1-3B_v13
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v13.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v13-ctx_8k params.yml setup.yml -H 1-3B_v13_hostfile

rm 1-3B_v13_hostfile