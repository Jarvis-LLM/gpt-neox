...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v16-learn_chinese_with_expanded_vocab.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v16-learn_chinese_with_expanded_vocab params.yml setup.yml -H 7B_v16_hostfile
