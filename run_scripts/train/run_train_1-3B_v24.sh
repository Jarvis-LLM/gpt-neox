...
#SBATCH --job-name=train_1-3B_v24
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v24.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v24-en_80B_cn_20B params.yml setup.yml -H 1-3B_v24_hostfile

rm 1-3B_v24_hostfile