...
### 指定该作业的输出文件
#SBATCH --output=train_7B_v20-continue_train_v16_with_translate.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v20-continue_train_v16_with_translate params.yml setup.yml -H 7B_v20_hostfile
