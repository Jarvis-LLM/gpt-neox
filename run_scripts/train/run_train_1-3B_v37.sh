...
#SBATCH --job-name=train_1-3B_v37
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v37.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v37-en_20B_cn_hq+cicg_4_1_10B params.yml setup.yml -H 1-3B_v37_hostfile

rm 1-3B_v37_hostfile