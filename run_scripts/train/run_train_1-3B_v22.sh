...
#SBATCH --job-name=train_1-3B_v22
...
### 指定该作业的输出文件
#SBATCH --output=train_1-3B_v22.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v22-plus_25B_en_based_on_v11 params.yml setup.yml -H 1-3B_v22_hostfile

rm 1-3B_v22_hostfile