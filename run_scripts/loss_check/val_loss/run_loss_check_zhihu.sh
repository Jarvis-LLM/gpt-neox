...
#SBATCH --job-name=loss_check_zhihu_val_loss
...
### 指定该作业的输出文件
#SBATCH --output=loss_check_zhihu_val_loss.log
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/65B/val_loss_check/zhihu params.yml setup.yml -H 65B_v3_hostfile
